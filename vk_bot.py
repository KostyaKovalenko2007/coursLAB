...
class vkBOT():
    ...
    def get_next_in_searchResults(self, ClientID):
        ...
        self.db.session.query(SearchResult).filter(SearchResult.clientID==client.id and SearchResult.id > client.currentSearchID)
    ...
    def get_user_photos(self,vkID):
        ...
        try:
            ...
            return  sorted(photo_dict,key=lambda x:x[1], reverse=True)[:3] # sorted list of photo by Likes, limited by to 3
